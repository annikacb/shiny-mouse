...
ui <- #navbarPage(
  ...
  tabPanel( title = "Home", icon = icon("home"),
           ...
           <p> This app provides complementary visualizations and aims to help with the exploration of Olink data generated from murine DBS samples. The app includes visualizations of the longitudinal protein profiles for each protein, the protein-protein correlations, and the data quality controls.
              <br>
              <b> Data </b> used in the study can be found at <a href='https://doi.org/10.17044/scilifelab.27368322' target='_blank' rel='noopener noreferrer'><strong> 10.17044/scilifelab.27368322</strong></a>, and <a href='https://github.com/Schwenk-Lab/mouse_dbs' target='_blank' rel='noopener noreferrer'><strong> code</strong></a> used is found at the Schwenk Lab Github account.
              <br><br>
